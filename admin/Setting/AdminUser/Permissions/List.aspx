<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true"
    CodeBehind="List.aspx.cs" Inherits="CRM.admin.Setting.AdminUser.Permissions.List" %>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="text-align: left;">
                                <%#Eval("CRM_SystemAccess.FriendlyName") %>
                            </td>
                            <td style="text-align: left;">
                                <%#Eval("CRM_SystemAccess.Path") %>
                            </td>
                            <td style="text-align: center;">
                                <asp:CheckBox ID="chkRead" runat="server" Checked='<%# Eval("IsRead") %>' />
                            </td>
                            <td style="text-align: center;">
                                <asp:CheckBox ID="chkAdd" runat="server" Checked='<%# Eval("IsAdd") %>' Enabled='<%# (byte)Eval("CRM_SystemAccess.Type") == (byte)CRM.Code.Models.CRM_SystemAccess.PageTypes.list ? false : true %>' />
                            </td>
                            <td style="text-align: center;">
                                <asp:CheckBox ID="chkEdit" runat="server" Checked='<%# Eval("IsWrite") %>' Enabled='<%# (byte)Eval("CRM_SystemAccess.Type") == (byte)CRM.Code.Models.CRM_SystemAccess.PageTypes.list ? false : true %>' />
                            </td>
                            <td style="text-align: center;">
                                <asp:CheckBox ID="chkDelete" runat="server" Checked='<%# Eval("IsDelete") %>' Enabled='<%# (byte)Eval("CRM_SystemAccess.Type") == (byte)CRM.Code.Models.CRM_SystemAccess.PageTypes.list ? false : true %>' />
                            </td>
                        </tr>
                    </ItemTemplate>
