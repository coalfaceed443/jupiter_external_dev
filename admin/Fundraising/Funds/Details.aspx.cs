...
namespace CRM.admin.Fundraising.Funds
{
    ...
    {
        protected CRM.Code.Models.CRM_Fund Entity = null;

        protected void Page_Load(object sender, EventArgs e)
        {
            RunSecurity(CRM.Code.Models.Admin.AllowedSections.NotSet);
            Entity = db.CRM_Funds.SingleOrDefault(c => c.ID.ToString() == Request.QueryString["id"]);
            ...
            confirmationDelete.StandardDeleteHidden("fund", btnRealDelete_Click);
        ...
        private void PopulateFields()
        {
            ...
            txtTemplate.Text = Entity.ThankyouTemplate;
        ...
        protected void SaveRecord(bool newRecord)
        {
            ...
            {
                Entity = new CRM_Fund();
                db.CRM_Funds.InsertOnSubmit(Entity);
                Entity.OrderNo = Code.Utils.Ordering.Ordering.GetNextOrderID(db.CRM_Funds);
            }

            Entity.Name = txtName.Text;
            Entity.ThankyouTemplate = txtTemplate.Text;
