...
namespace CRM.admin.Fundraising.Reasons
{
    ...
    {
        protected CRM.Code.Models.CRM_FundraisingReason Entity = null;

        protected void Page_Load(object sender, EventArgs e)
        {
            RunSecurity(CRM.Code.Models.Admin.AllowedSections.NotSet);
            Entity = db.CRM_FundraisingReasons.SingleOrDefault(c => c.ID.ToString() == Request.QueryString["id"]);
            ...
            confirmationDelete.StandardDeleteHidden("reason", btnRealDelete_Click);
        ...
        protected void SaveRecord(bool newRecord)
        {
            ...
            if (newRecord)
            {
                Entity = new CRM_FundraisingReason();
                db.CRM_FundraisingReasons.InsertOnSubmit(Entity);
                Entity.OrderNo = Code.Utils.Ordering.Ordering.GetNextOrderID(db.CRM_FundraisingReasons);
            }
