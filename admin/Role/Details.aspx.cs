...
namespace CRM.admin.Role
{
    public partial class Details : AdminPage
    {
        protected CRM.Code.Models.CRM_Role Entity = null;

        protected void Page_Load(object sender, EventArgs e)
        {
            RunSecurity(CRM.Code.Models.Admin.AllowedSections.NotSet);
            Entity = db.CRM_Roles.SingleOrDefault(c => c.ID.ToString() == Request.QueryString["id"]);
        ...
        protected void SaveRecord(bool newRecord)
        {
            ...
            {
                Entity = new  CRM_Role();
                db.CRM_Roles.InsertOnSubmit(Entity);
            }
