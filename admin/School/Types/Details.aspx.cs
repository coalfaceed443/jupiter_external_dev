...
namespace CRM.admin.School.Type
{
    public partial class Details : AdminPage
    {
        protected CRM.Code.Models.CRM_SchoolType Entity = null;

        protected void Page_Load(object sender, EventArgs e)
        {
            RunSecurity(CRM.Code.Models.Admin.AllowedSections.NotSet);
            Entity = db.CRM_SchoolTypes.SingleOrDefault(c => c.ID.ToString() == Request.QueryString["id"]);
            ...
            confirmationDelete.StandardDeleteHidden("school type", btnRealDelete_Click);
        ...
        protected void SaveRecord(bool newRecord)
        {
            ...
            if (newRecord)
            {
                Entity = new CRM_SchoolType();
                Entity.IsArchived = false;
                Entity.OrderNo = Ordering.GetNextOrderID(db.CRM_SchoolTypes);
                db.CRM_SchoolTypes.InsertOnSubmit(Entity);
            }
