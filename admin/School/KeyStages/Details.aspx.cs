...
namespace CRM.admin.School.KeyStages
{
    ...
    {
        protected CRM.Code.Models.CRM_KeyStage Entity = null;

        protected void Page_Load(object sender, EventArgs e)
        {
            RunSecurity(CRM.Code.Models.Admin.AllowedSections.NotSet);
            Entity = db.CRM_KeyStages.SingleOrDefault(c => c.ID.ToString() == Request.QueryString["id"]);
            ...
            confirmationDelete.StandardDeleteHidden("key stages", btnRealDelete_Click);
        ...
        protected void SaveRecord(bool newRecord)
        {
            ...
            if (newRecord)
            {
                Entity = new  CRM_KeyStage();
                Entity.OrderNo = CRM.Code.Utils.Ordering.Ordering.GetNextOrderID(db.CRM_KeyStages);
                db.CRM_KeyStages.InsertOnSubmit(Entity);
            }
