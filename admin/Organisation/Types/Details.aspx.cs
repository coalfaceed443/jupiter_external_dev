...
namespace CRM.admin.Organisation.Type
{
    public partial class Details : AdminPage
    {
        protected CRM.Code.Models.CRM_OrganisationType Entity = null;

        protected void Page_Load(object sender, EventArgs e)
        {
            RunSecurity(CRM.Code.Models.Admin.AllowedSections.NotSet);
            Entity = db.CRM_OrganisationTypes.SingleOrDefault(c => c.ID.ToString() == Request.QueryString["id"]);
            ...
            confirmationDelete.StandardDeleteHidden("organisation type", btnRealDelete_Click);
        ...
        protected void SaveRecord(bool newRecord)
        {
            ...
            if (newRecord)
            {
                Entity = new CRM_OrganisationType();
                Entity.IsActive = true;
                Entity.IsArchived = false;
                db.CRM_OrganisationTypes.InsertOnSubmit(Entity);
            }
