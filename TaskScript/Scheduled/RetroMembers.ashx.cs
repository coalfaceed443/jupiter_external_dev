...
{
    /// <summary>
    /// Summary description for RetroMembers
    /// </summary>
    public class RetroMembers : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            foreach (CRM_AnnualPass pass in dueReminders)
            {
                try
                {
                    ...
                    {
                        if (person.PrimaryEmail != "bollandpm@aol.com" && person.PrimaryEmail != "fiona@fruitmarket.co.uk")
                        {
