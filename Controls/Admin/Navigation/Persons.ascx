...
<div class="sectionMenuContainer">
    ...
    <div class="sectionMenu" id="divHolder" runat="server">
        ...
        <div class="sectionMenuItem" runat="server" id="navGiftAid">
            <a href='/admin/person/gift/list.aspx?id=<%= Entity.ID %>' title="Gift aid profiles for this person">Gift Aid Profiles</a>
        </div>

        <div class="sectionMenuItem" runat="server" id="navAttendance">
            <a href='/admin/person/attendance/list.aspx?id=<%= Entity.ID %>' title="Any records of attendance for this person">Attendance History</a>
        </div>
